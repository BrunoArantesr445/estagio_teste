...
--
-- Temporary view structure for view `diferenca_carga_horaria_supervisor`
--

DROP TABLE IF EXISTS `diferenca_carga_horaria_supervisor`;
/*!50001 DROP VIEW IF EXISTS `diferenca_carga_horaria_supervisor`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `diferenca_carga_horaria_supervisor` AS SELECT 
 1 AS `escala_id`,
 1 AS `carga_horaria_escala`,
 1 AS `carga_horaria_supervisor`,
 1 AS `diferenca_carga_horaria`*/;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `escala` VALUES (1,'2024-02-05','santa casa','24-12-24','manha','santa casa',1,'13','1','42','06:00-13:00','uc4',1),(18,'2024-02-05','Santa Casa','2024-02-10','Manhã','Santa Casa',1,'20','5','25h','2024-02-05 08:00:00','uc4',1),(19,'2024-03-01','Hospital Geral','2024-03-10','Tarde','Hospital Geral',2,'15','4','30h','2024-03-01 14:00:00','uc7',2),(20,'2024-04-15','Clínica Saúde Total','2024-04-20','Noite','Clínica Saúde Total',3,'10','3','20h','2024-04-15 19:00:00','uc11',3),(21,'2024-05-05','Hospital São José','2024-05-12','Manhã','Hospital São José',4,'25','6','35h','2024-05-05 08:00:00','uc17',4),(22,'2024-06-10','Centro Tecnológico','2024-06-15','Manhã e Tarde','Centro Tecnológico',5,'18','5','40h','2024-06-10 09:00:00','uc7',5),(23,'2024-07-20','Universidade Federal','2024-07-25','Tarde','Universidade Federal',6,'12','4','30h','2024-07-20 13:00:00','uc4',6),(24,'2024-08-05','Laboratório XYZ','2024-08-10','Noite','Laboratório XYZ',7,'8','3','20h','2024-08-05 20:00:00','uc11',7),(25,'2024-09-15','Escola Estadual DEF','2024-09-20','Manhã','Escola Estadual DEF',8,'30','7','50h','2024-09-15 08:00:00','uc17',8),(26,'2024-10-10','Instituto de Pesquisa','2024-10-18','Manhã e Noite','Instituto de Pesquisa',9,'22','6','40h','2024-10-10 09:00:00','uc4',9),(27,'2024-11-01','Clínica Bem Viver','2024-11-07','Tarde e Noite','Clínica Bem Viver',10,'14','5','30h','2024-11-01 14:00:00','uc7',10);
...
INSERT INTO `reserva` VALUES (1,1,'2024-11-25',1,1,NULL),(2,1,'2024-11-26',24,2,NULL);
...
INSERT INTO `status` VALUES (1,1,'45','12','8');
/*!40000 ALTER TABLE `status` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `status_aluno`
--

DROP TABLE IF EXISTS `status_aluno`;
/*!50001 DROP VIEW IF EXISTS `status_aluno`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `status_aluno` AS SELECT 
 1 AS `aluno_id`,
 1 AS `aluno_nome`,
 1 AS `total_faltas`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `supervisor` (
  ...
  `telefone` varchar(45) DEFAULT NULL,
  `carga_horaria` varchar(45) DEFAULT NULL,
  `status` enum('Disponível','Alocado') DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `supervisor` VALUES (1,'igor','Manhã','uc4','216354532','30','Disponível'),(2,'fabio','Tarde','uc7','35412135','20','Alocado'),(3,'fabio','Tarde','uc11','888999001','20h','Disponível'),(4,'Professor A','Manhã','uc17','111222333','20h','Alocado'),(5,'Professor B','Tarde','uc17','444555666','30h','Disponível'),(6,'Professor C','Noite','uc7','777888999','25h','Alocado'),(7,'Professor D','Manhã e Tarde','uc7','000111222','40h','Disponível'),(8,'Professor E','Tarde','uc17','333444555','15h',NULL),(9,'Professor F','Manhã','uc17','666777888','35h',NULL),(10,'Professor G','Noite','uc7','999000111','30h',NULL),(11,'Professor H','Manhã e Tarde','uc7','222333444','20h',NULL),(12,'Professor I','Tarde','uc17','555666777','25h',NULL),(13,'Professor J','Noite','uc17','888999000','30h',NULL),(14,'Prof. André Silva','Manhã','uc17','98888-1111','40h',NULL),(15,'Prof. Beatriz Souza','Tarde','uc4','98888-2222','30h',NULL),(16,'Prof. Carlos Santos','Noite','uc4','98888-3333','20h',NULL),(17,'Prof. Daniela Almeida','Manhã e Tarde','uc4','98888-4444','35h',NULL),(18,'Prof. Eduardo Gomes','Manhã e Noite','uc11','98888-5555','30h',NULL),(19,'Prof. Fernanda Rocha','Tarde e Noite','uc4','98888-6666','40h',NULL),(20,'Prof. Gustavo Martins','Manhã','uc4','98888-7777','25h',NULL),(21,'Prof. Helena Oliveira','Tarde','uc4','98888-8888','20h',NULL),(22,'Prof. Igor Correia','Noite','uc11','98888-9999','30h',NULL),(23,'Prof. Júlia Nascimento','Manhã e Tarde','uc7','98888-0000','35h',NULL),(24,'teteu','Manhã','uc7',NULL,NULL,NULL),(25,'igor2','Manhã','med ','1489652','12',NULL);
/*!40000 ALTER TABLE `supervisor` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `supervisor_disponível`
--

DROP TABLE IF EXISTS `supervisor_disponível`;
/*!50001 DROP VIEW IF EXISTS `supervisor_disponível`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `supervisor_disponível` AS SELECT 
 1 AS `nome_sepervisor`,
 1 AS `turno`,
 1 AS `contato`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `diferenca_carga_horaria_supervisor`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`administrador`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `diferenca_carga_horaria_supervisor` AS select `e`.`id` AS `escala_id`,`e`.`carga_horaria` AS `carga_horaria_escala`,`s`.`carga_horaria` AS `carga_horaria_supervisor`,(cast(`e`.`carga_horaria` as decimal(10,0)) - cast(`s`.`carga_horaria` as decimal(10,0))) AS `diferenca_carga_horaria` from (`escala` `e` join `supervisor` `s` on((`e`.`supervisor_id` = `s`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `status_aluno`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`administrador`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `status_aluno` AS select `a`.`id` AS `aluno_id`,`a`.`nome` AS `aluno_nome`,count(`f`.`id`) AS `total_faltas` from (`alunos` `a` left join `status` `f` on((`a`.`id` = `f`.`horas_faltada`))) group by `a`.`id`,`a`.`nome` order by `total_faltas` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `supervisor_disponível`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`administrador`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `supervisor_disponível` AS select `supervisor`.`nome` AS `nome_sepervisor`,`supervisor`.`disponibilidade_horario` AS `turno`,`supervisor`.`telefone` AS `contato` from `supervisor` where (`supervisor`.`status` = 'Disponível') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-11-25 11:32:16
